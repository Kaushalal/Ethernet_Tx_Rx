...
class mac_to_axi_s_env extends uvm_env;
  ...
  `uvm_component_utils(mac_to_axi_s_env)
   ...
   emac_tx2rx_scrbd                   mac_tx_to_rx_scrbrd;
...
////----------------------------------------------------------------------/////
   function void build_phase(uvm_phase phase);
     ...
     mac_tx_to_rx_scrbrd = emac_tx2rx_scrbd::type_id::create("mac_tx_to_rx_scrbrd",this);
   ...
   function void connect_phase(uvm_phase phase);
     ...
     //                  ------   SCOREBOARD CONNECTION
       ...
       foreach( mac_rx_uvc_h.mac_rx_agent_h[i] )begin
                mac_rx_uvc_h.mac_rx_agent_h[i].mac_rx_mon.mac_rx_item_collected_port.connect(mac_tx_to_rx_scrbrd.act_mon_port[i]);
                end   

       mac_tx_to_rx_ref.expected_port3.connect(mac_tx_to_rx_scrbrd.exp_ref_port[0]);
       mac_tx_to_rx_ref.expected_port4.connect(mac_tx_to_rx_scrbrd.exp_ref_port[1]);
       mac_tx_to_rx_ref.expected_port5.connect(mac_tx_to_rx_scrbrd.exp_ref_port[2]);
